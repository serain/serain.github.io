...
![Unicorns don't just poop rainbows](images/posts/gitoops/devseccon.png)
...
![all the secrets](images/posts/gitoops/screenshot.png)
...
![terraform status checks](images/posts/gitoops/status-checks.png)
